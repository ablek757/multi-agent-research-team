...
- **认知探索工作台**：把 Multi-Agent 的黑盒研究过程变成可观测、可干预、可分叉的交互式研究图谱，让用户从“等报告”变成“驾驶研究”。
...
启动前后端后，访问 `http://localhost:3000/workbench`：
...
在工作台中你可以：
- **观测**：实时查看研究计划、子任务、搜索、来源、发现、反思等节点构成的力导向图谱
- **干预**：在研究运行中注入搜索查询、暂停/继续、添加信息缺口或主题
- **分叉**：从任意检查点复制当前研究状态，生成独立的新研究会话继续探索
